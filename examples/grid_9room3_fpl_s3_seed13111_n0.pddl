(define (problem grid_9room3_fpl_s3_seed13111_n0)
  (:domain grid)
  (:objects
  ...
  (:init
    ...
    (below p79 p89)
    ; Lock and key shapes
    (lock_shape p16 shape2)
    (lock_shape p34 shape0)
    (lock_shape p60 shape0)
    (lock_shape p83 shape0)
    (lock_shape p3 shape1)
    (lock_shape p30 shape2)
    (lock_shape p47 shape0)
    (lock_shape p29 shape2)
    (lock_shape p67 shape1)
